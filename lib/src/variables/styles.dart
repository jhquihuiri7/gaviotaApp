...
TextStyle titleText = const TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black);
...
TextStyle iconText = const TextStyle(fontSize: 10, fontStyle: FontStyle.italic, color: Colors.black);
